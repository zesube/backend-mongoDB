addEventListener("DOMConnectLoaded", function() {
...
async function addSong() {
    //create a song object based on the form that the user fills out. this will make life eaiser when we send the data to the backend
    const song = {
